    ...
    return (
      ...
      >
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary">
          <BlockQuote>
            <Quote>
              An open group focused on developing and mentoring programmers and
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <List>
            ...
            <ListItem>
              Signup to participate in Hacktober at
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <List>
            <ListItem>
              Create your own copy <em>fork</em>
            </ListItem>
            <ListItem>
              Download code on your computer <em>clone</em>
            </ListItem>
            <ListItem>
              Track your changes by making a <em>branch</em>
            </ListItem>
            <ListItem>
              <em>commit</em> your local changes
            </ListItem>
          </List>
        </Slide>
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <List>
            <ListItem>
              <em>pull</em> and update your local fork with work others have
              done
            </ListItem>
            <ListItem>
              Fix any <em>merge</em> issues
            </ListItem>
            <ListItem>
              Confirm your code didn't break anything by running any tests
            </ListItem>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <List>
            <ListItem>
              <em>push</em> changes to your fork, by creating a new branch
            </ListItem>
            <ListItem>
              Create a <em>pull request</em> against the original repository
            </ListItem>
            <ListItem>
              Wait till your pull request is approved / reviewed
            </ListItem>
